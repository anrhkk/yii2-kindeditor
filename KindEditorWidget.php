...
EOT;
        ...
        $view->registerJsFile($asset->baseUrl . '/lang/' . $this->clientOptions['langType'] . '.js', ['depends' => '\kindeditor\KindEditorAsset']);
        $js = "
KindEditor.ready(function(K) {
    ...
    protected function defaultOptions()
    {
        return [
            'id'    => $this->id,
            'name'  => $this->name,
            'fileManagerJson'   => Url::to(['upload/index', 'action' => 'fileManagerJson']),
            'uploadJson'    => Url::to(['upload/index', 'action' => 'uploadJson']),
            'width' => '80%',
            'height' => '400px',
            'allowFileManager' => true,
